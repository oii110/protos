...
type LoginRequest struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	PpId          int32                  `protobuf:"varint,3,opt,name=pp_id,json=ppId,proto3" json:"pp_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginRequest) GetPpId() int32 {
	if x != nil {
		return x.PpId
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x05pp_id\x18\x03 \x01(\x05R\x04ppId\"+\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x12Z\x10gen/go/sso;ssov1b\x06proto3"
